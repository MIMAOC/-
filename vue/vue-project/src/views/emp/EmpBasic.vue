    ...
    <div>
      <div style="display: flex;justify-content: space-between;">
        ...
        <div style="margin-top: 10px;">
          <el-input style="width: 400px;margin-right: 30px;"
            ...
            <el-col :span="5">
              ...
              <el-popover
                ...
                <div slot="reference" style="width: 130px;
                  ...
                  height: 26px" @click="showDepView2">{{ inputDepName }}
                </div>
              </el-popover>
            </el-col>
          ...
          <el-row>
            ...
            <el-col :span="7">
              <el-form-item label="联系地址：" prop="address">
                <el-input v-model="emp.address" placeholder="请输入联系地址" prefix-icon="el-icon-location-outline" size="mini"
            ...
            <el-col :span="6">
              ...
              <el-form-item label="所属部门 :" prop="departmentId">
                <el-popover
                  ...
                  <div slot="reference" style="width: 150px;
                  display: inline-flex;
                  border: 1px solid #dedede;
                  margin-top: 6px;
                  border-radius: 5px;
                  ...
                  padding-left: 8px;
                  box-sizing: border-box;
                  height: 26px" @click="showDepView">{{ inputDepName }}
                  </div>
                </el-popover>
              </el-form-item>
            </el-col>
